 ...
 */
var daysOfTheMonth: [String: Int] = ["January": 31, "February": 28, "March": 31]
 ...
 */
daysOfTheMonth.updateValue(29, forKey: "February")
print(daysOfTheMonth)
/*:
 Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
 */
if let januaryDays = daysOfTheMonth["January"] {
 ...
 */
if let colours = shapesAndColors["Colors"] {
    print(colours[2])
}
