...
var rektangle = Rectangle(width: 45, height: 80)
print(rektangle.area)
/*:
...
var heightCheckOne = Height(heightInCentimeters: 50)
print(heightCheckOne.heightInCentimeters)
print(heightCheckOne.heightInInches)
