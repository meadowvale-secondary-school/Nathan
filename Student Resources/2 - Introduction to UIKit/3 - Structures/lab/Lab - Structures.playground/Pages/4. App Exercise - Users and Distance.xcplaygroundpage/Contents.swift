 ...
 */
var Nathan = User(name: "nathan", age: 16, height: 140, weight: 110, activityLevel: 5)
print(Nathan)
/*:
...
var customDistance = Distance(meters: 1)
print(customDistance.feet)
/*:
 ...
 */
var someOtherDistance = Distance(meters: 30)
