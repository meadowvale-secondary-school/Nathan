...
var runningWorkoutStats = RunningWorkout(distance: 5000, time: 1200, elevation: 13)
print(runningWorkoutStats.averageMileTime)
/*:
...
var almostMetGoal = Steps(steps: 9999, goal: 10000)
print(almostMetGoal.steps)
almostMetGoal.takeStep()
print(almostMetGoal.steps)
