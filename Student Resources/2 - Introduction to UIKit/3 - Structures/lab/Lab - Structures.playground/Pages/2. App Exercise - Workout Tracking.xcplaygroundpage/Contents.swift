 ...
 */
var firstRun = RunningWorkout(distance: 0, time: 0, elevatoin: 0)
 ...
 */
firstRun = RunningWorkout(distance: 2396, time: 15.3, elevatoin: 94)
print("These are the stats for my morning exercies \(firstRun)")
