 ...
 */
var Number_of_likes:Int = 30
var Number_of_comments:Int = 2
let yearCreated:Int = 2003
let monthCreated:Int = 04
let dayCreated:Int = 17
print(dayCreated,monthCreated,yearCreated,Number_of_likes,Number_of_comments)
